...
-(void)themeBtnStyle{
    ...
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor blackColor]] forState:UIControlStateDisabled];
}
...
-(void)lightGrayBtnStyle{
    ...
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.titleLabel.font = [UIFont boldSystemFontOfSize:16.f];
    self.backgroundColor = [UIColor colorFromHexRGB:ThemeColor];
    self.layer.borderColor = [UIColor colorFromHexRGB:ThemeColor].CGColor;
    [self setBackgroundImage:[self buttonImageFromColor:COLOR(20, 121, 209, 1)] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor blackColor]] forState:UIControlStateDisabled];
}
...
-(void)writeBtnStyle{
    ...
    self.layer.masksToBounds = YES;
    [self setAdjustsImageWhenHighlighted:NO];
    [self setTitleColor: [UIColor colorWithRed:100.0/255.0 green:100/255.0 blue:100/255.0 alpha:1] forState:UIControlStateNormal];
    //[self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
    self.titleLabel.font = [UIFont boldSystemFontOfSize:12.f];
    self.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:255/255.0 blue:255/255.0 alpha:1];
    self.layer.borderColor = [[UIColor clearColor] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:237/255.0 green:237/255.0 blue:237/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)borderBtnStyle{
    ...
    self.layer.masksToBounds = YES;
    [self setAdjustsImageWhenHighlighted:NO];
    [self setTitleColor:[UIColor colorFromHexRGB:@"747474"]
               forState:UIControlStateNormal];
    //[self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
    self.titleLabel.font = [UIFont systemFontOfSize:18.f];
    self.backgroundColor = [UIColor clearColor];
    self.layer.borderColor = COLOR(158, 158, 158, 1).CGColor;
